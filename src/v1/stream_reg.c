...
RS_CODE RS_register_spi1_2(){
    ...
    rs_res = RS_update_common(write_cmd);
    ...
    rs_res = RS_read_common(read_cmd, &ack_len, read_data);
    ...
    rs_res = RS_update_xyz(write_cmd);
    ...
    rs_res = RS_read_xyz(read_cmd, &ack_len, read_data);
    ...
    if(gv.IS_SET_BPF == 1){
        ...
        rs_res = RS_update_iircoef(write_cmd);
        ...
        rs_res = RS_read_iircoef(read_cmd, &ack_len, read_data);
...
RS_CODE RS_update_xyz(uint8_t* update_cmd){
    ...
    memcpy(gv.write_cmd, update_cmd, EC_MAX_XYZ_LEN * sizeof(uint8_t));
...
RS_CODE RS_read_xyz(uint8_t* read_cmd, uint32_t* ack_len, uint8_t* read_ack){
    ...
    *ack_len = EC_MAX_XYZ_LEN;

    memcpy(read_ack, gv.read_data, EC_MAX_XYZ_LEN * sizeof(uint8_t));
...
RS_CODE RS_update_iircoef(uint8_t* update_cmd){
    ...
    memcpy(gv.write_cmd, update_cmd, EC_MAX_IIR_COEF_LEN * sizeof(uint8_t));
...
RS_CODE RS_read_iircoef(uint8_t* read_cmd, uint32_t* ack_len, uint8_t* read_ack){
    ...
    *ack_len = EC_MAX_IIR_COEF_LEN;

    memcpy(read_ack, gv.read_data, EC_MAX_IIR_COEF_LEN * sizeof(uint8_t));
...
RS_CODE RS_update_common(uint8_t* update_cmd){
    ...
    memcpy(gv.write_cmd, update_cmd, EC_MAX_COMMON_LEN * sizeof(uint8_t));
...
RS_CODE RS_read_common(uint8_t* read_cmd, uint32_t* ack_len, uint8_t* read_ack){
    ...
    *ack_len = EC_MAX_COMMON_LEN;

    memcpy(read_ack, gv.read_data, EC_MAX_COMMON_LEN * sizeof(uint8_t));
