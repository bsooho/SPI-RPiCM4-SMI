#ifndef _RPSPI_DMA_SERVER_H_
#define _RPSPI_DMA_SERVER_H_
...
extern char *spi_regstrs[];

extern char *dma_regstrs[];

extern uint32_t usec_start;


extern char stream_buff[STREAM_BUFFLEN];
extern uint32_t rx_buff[MAX_SAMPS];
...
extern MEM_MAP spi_regs;
extern MEM_MAP usec_regs;
...
extern uint32_t samp_total;
extern uint32_t overrun_total;
